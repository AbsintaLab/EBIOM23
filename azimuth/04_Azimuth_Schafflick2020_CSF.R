...
#   write_tsv("out/table/schafflick_csf_CoordUMAP_curated.tsv")
# 
# object@reductions$umap@cell.embeddings %>%
#   data.frame() %>%
#   rownames_to_column("barcodes") %>%
...
# saveRDS(object_diet,"out/object/diet_schafflick_csf.rds")
query <- LoadFileInput(path = "out/object/diet_schafflick_csf.rds")

# schafflick_csfl: for this dataset Martina asked to score all the cells, but to keep the one from cluster 4 and 9 which are immun cells
