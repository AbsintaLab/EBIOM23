...
# sasve the table
# write_tsv(df_tables_GSEA_all,file = "out/df_tables_GSEA_test_out_IMMUNE_BTK_KO_KEGG.tsv")
# write_tsv(df_tables_GSEA_all,file = "out/df_tables_GSEA_test_out_IMMUNE_BTK_KO_HALLMARK.tsv")
write_tsv(df_tables_GSEA_all,file = "out/table/df_tables_GSEA_test_out_IMMUNE_BTK_KO_REACTOME.tsv")
...
# save the table
# df_tables_GSEA_all_non_redundant %>%
#   write_tsv(file = "out/df_tables_GSEA_test_out_IMMUNE_BTK_KEGG_KO_non_redundant.tsv")
# df_tables_GSEA_all_non_redundant %>%
#   write_tsv(file = "out/df_tables_GSEA_test_out_IMMUNE_BTK_KO_HALLMARK_non_redundant.tsv")
df_tables_GSEA_all_non_redundant %>%
  write_tsv(file = "out/table/df_tables_GSEA_test_out_IMMUNE_BTK_KO_REACTOME_non_redundant.tsv")
# df_tables_GSEA_all %>%
#   filter(dataset == "ENDO") %>%
...
ggsave("out/image/GSEA_test_out_IMMUNE_BTK_KO_non_redundant_REACTOME.pdf",width = 5,height = 5)
...
#   ggplot(aes(y = -log10(padj),x = NES,label = pathway2)) + geom_point(aes(size = size),alpha = 0.2) + facet_wrap(~dataset) + theme_bw() + 
#   geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)
# ggsave("images/GSEA_test_out_IMMUNE_BTK_KO_non_redundant_KEGG.pdf",width = 5,height = 5)
...
# ggsave("images/GSEA_test_out_IMMUNE_BTK_KO_all_KEGG.pdf",width = 5,height = 5)
...
df_tables_GSEA_all %>%
  ...
  geom_text_repel(size = 2,
                  ...
                  box.padding = 0.8,
                  segment.alpha = 0.1,max.overlaps = 8)
ggsave("out/image/GSEA_test_out_IMMUNE_BTK_KO_all_REACTOME.pdf",width = 5,height = 5)
...
# ggsave(filename = "images/GSEA_plot_profile_IMMUNE_BTK_KO_non_redundant_KEGG.pdf",width = 15,height = 10)
...
wrap_plots(plot_pathway)
ggsave(filename = "out/image/GSEA_plot_profile_IMMUNE_BTK_KO_non_redundant_REACTOME.pdf",width = 15,height = 10)
...
# 
# wrap_plots(plot_pathway)
# ggsave(filename = "images/GSEA_plot_profile_IMMUNE_BTK_KO_all_KEGG.pdf",width = 15,height = 15)
...
wrap_plots(plot_pathway)
ggsave(filename = "out/image/GSEA_plot_profile_IMMUNE_BTK_KO_all_REACTOME.pdf",width = 15,height = 15)
